// Chuck - The plugin is edited based on the open-source code: https://github.com/suan/jquery-keycombinator
// It is slightly edited (ex. keycodes of numpad) and unwanted functions are removed (ex. clear and revert-to-default).
